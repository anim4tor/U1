...
<section class="solutions" data-tabs="hoverable" theme="invert" >
	...
	<div class="grid__4  place__end-stretch mobile:grid__1 mobile:inner-t__10 mobile:gap__2 relative inner-b__5">
		<ul class="span__3 solutions__list grid inner__1 inner-t__2" data-scroll>
			<?php foreach (collection('Solutions') as $solution) : ?>
				<a href="<?= $solution->url() ?>" class="flex align__start gap__05 inner-y__02" data-tab="service-<?= $solution->slug() ?>">
					<?= snippet('atoms/Heading', [ 'level' => 'h2', 'text' => $solution->title(), 'reveal' => true, 'css' => 's', 'node' => 'data-split-ignore data-scroll-ignore' ]) ?>
				</a>
			<?php endforeach ?>
		</ul>
