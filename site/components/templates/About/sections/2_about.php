...
<section class="about" theme="invert">
	<div class="grid grid-cols-1 md:grid-cols-3 gap-2 p-1 px-1 py-2 pb-5">
		...
		<div class="flex justify-end">(<?= snippet('molecules/Header', ['header' => $page->about(), 'type' => ['label']]) ?>)</div>
	</div>
	<div class="px-1 py-2">	
