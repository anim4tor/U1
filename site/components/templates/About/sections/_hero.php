...
<section class="intro radius" theme="acc" style="--in-delay: 500ms">
	...
	<div class="z__1 intro__header place__stretch-stretch grid__4 gap__2  mobile:grid__1 h__100v mobile:h__auto inner__4 mobile:inner-t__10 mobile:gap__2 relative color__invert">
		<div class="h__6"></div>
