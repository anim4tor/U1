<section class="testimonials radius">
	...
	<div class="relative grid__3 gap__2 h__100v mobile:grid__1 inner__1 mobile:inner-x__1 inner-y__2" >
		...
		<div class="grid place__center-center" data-scroll data-reveal-image>
			<div class="grid gap__2 place__space-between-start inner__1 radius" theme="light">
				<div class="grid gap__1">
					<?= snippet('atoms/Image', ['url' => 'testimonial.png', 'parallax' => 2, 'css' => 'w__3']) ?>
					<p class="quote ff__heading upper m">"Working with this team has been a game-changer for our business. Their attention to detail and ability to deliver high-quality results on schedule is unmatched. I highly recommend them to anyone looking for reliable and professional expertise."</p>
				</div>
