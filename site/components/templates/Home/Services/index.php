<section class="solutions" theme="dark" data-toggles>
	<div class="grid__2 place__start-stretch mobile:grid__1  mobile:inner-t__10 mobile:gap__2 relative inner-b__5" >
		<div class="sticky top__0 h__100v grid gap__1 inner__1 inner-t__2" data-scroll>
			<div class="" data-scroll>
				<h1 class="xl " data-reveal-text><span>Solutions</span></h1>
			</div>
				...
				<div class="grid__stack no__overflow radius">
					<?php foreach (collection('Solutions') as $solution) : ?>
						<?php if ($img = $solution->cover()->toFile()) : ?>
							<div class="" data-target="service-<?= $solution->slug() ?>"><?= snippet('atoms/Image', ['img' => $img, 'parallax' => 10, 'reveal' => false, 'css' => 'w__10 radius grid']) ?></div>
							
							<!-- <figure class="" data-target="service-<?= $solution->slug() ?>"><img alt="crypto" src="https://picsum.photos/id/<?= rand(0,100) ?>/200/300"></figure> -->
						<?php endif ?>
		...
		<ul class="solutions__list grid inner__1 inner-t__2">
			<?php foreach (collection('Solutions') as $solution) : ?>
				<div class="flex align__start gap__05 inner-y__05" data-scroll data-hover-toggle="service-<?= $solution->slug() ?>">
