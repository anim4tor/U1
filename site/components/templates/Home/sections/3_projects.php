...
<section class="projects radius" theme="dark" >
	...
	<div class="grid__3 gap__1 mobile:grid__1 inner-b__0  mobile:inner-x__1 " data-carousel>
		<div data-scroll class="span__2 inner-x__5 inner-t__2">
			<?= snippet('molecules/Header', ['header' => $page->projects(), 'type' => ['heading']]) ?>
		</div>
		<div class="flex gap__02 justify__end align__end inner-x__5 m">
		...
		<div class="span__3" data-carousel-scroll>
			<ol class="flex justify__start align__center no__wrap gap__0 inner-x__5 " data-carousel-slides >	
	...
	<div class="flex align__center gap__2 inner-x__5 no__overflow">
