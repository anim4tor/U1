<div class="grid place__start-stretch radius " theme="dark" data-contact-widget>
	<div data-tabs="cta" class="relative grid place__end-stretch " data-fluid>	
		<div class="flex sticky top__0 gap__03 inner-x__1 inner-y__05 border__bottom z__10" theme="dark">
			...
			<!-- <div data-tab="cta" class="upper xs none">Cta</div> -->
			<div data-tab="contact" class="upper xs">HR manager</div>
		...
		<div data-pane-container class="grid__stack place__start-stretch no__overflow">
			...
			<div data-pane="contact">
				<div class="z__1 grid wrap gap__05 inner-x__1 inner-y__1 inner-b__05">
					<h3 class="font__size__4">Máš o pozici zájem? <span class="color__acc">Just say it!</span></h3>
				...
				<div class="relative grid gap__05 place__end-stretch inner-x__1 inner-b__1">
					<div class="grid gap__05">
						<div>
							<p class="xs op__4">HR Business partner</p>
							<p class="lower l">Jitka Burdová</p>
						</div>
						<div class="flex gap__02">
