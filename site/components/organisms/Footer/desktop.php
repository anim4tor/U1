<footer id="footer" class="" theme="invert" data-footer data-scroll>
	...
	<div class="grid__4 gap__1 inner-x__1 inner-y__2 inner-b__1">
		...
		<nav class="span__3 footer__nav flex wrap align__center gap__02 ff__heading font__size__3 text-m">
		...
		<div class="relative span__4 grid__4 gap__1 inner-t__6">	
			...
			<div class="grid place__space-between-start gap__2">
				<div class="grid gap__02">
					<div class="label upper text-xs op__4">(Newsletter)</div>
			...
			<div class="grid place__space-between-start gap__02">
				...
				<div class="grid">
					<nav data-reveal-text="words" class="flex justify__space-between gap__05 op__5 font__size__default text-s">
